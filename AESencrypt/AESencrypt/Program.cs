...
namespace AESencrypt
{
    class Program
    {
        ...
        {
            Console.WriteLine("What To encrypt:");
            string inputString;
            ...
            Console.WriteLine("Encrypted String:" + EncryptText(inputString, passwordString));
            Console.WriteLine("Decrypted String:" + DecryptText(EncryptText(inputString, passwordString), passwordString));
            Console.ReadKey();
        }
